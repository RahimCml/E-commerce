function printSelect(selectedProduct) {
	console.log(
		`${selectedProduct.customer.name} has chosen the ${selectedProduct.productName.productName} from ${selectedProduct.seller.name}, address: ${selectedProduct.customer.address}, price: ${selectedProduct.productName.price}`
	);
}
